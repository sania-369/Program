...
"""
🌀 ETVP v12.9 HYBRID — clip (C ≤ 0.8) ↔ tanh (C > 0.8)

Логика:
- C ≤ 0.8 — низкая плотность вакуума (ЧД, глубокий космос) → clip.
- C > 0.8 — высокая плотность (наш режим, галактики) → tanh.

Цель: сравнить три режима (clip / tanh / hybrid) на одних данных.
"""
...
def etve_tanh_limit(C, c_min=GLOBAL_C_MIN, c_max=GLOBAL_C_MAX,
                    c_soft_low=0.999333111, c_soft_high=1):
    """
